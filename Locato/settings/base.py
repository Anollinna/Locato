"""
Django settings for Locato project.
...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", "django-insecure-4$wl8"
...
WSGI_APPLICATION = "Locato.wsgi.application"
